...
import 'cad_endereco_model.dart';
export 'cad_endereco_model.dart';

class CadEnderecoWidget extends StatefulWidget {
  const CadEnderecoWidget({super.key});

  static String routeName = 'CadEndereco';
  static String routePath = '/cadEndereco';

  @override
  State<CadEnderecoWidget> createState() => _CadEnderecoWidgetState();
}

class _CadEnderecoWidgetState extends State<CadEnderecoWidget>
    with TickerProviderStateMixin {
  late CadEnderecoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CadEnderecoModel());
                          ...
                          children: [
                            Align(
                              ...
                              child: TabBar(
                                ...
                                indicatorColor: Color(0xFF5A5757),
                                tabs: [
                                  Tab(
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: Container(
                                            ...
                                            child: TextFormField(
                                              controller: _model
                                                  .textFieldReferenciaTextController,
                                              focusNode: _model
                                                  .textFieldReferenciaFocusNode,
                                              autofocus: false,
                                              enabled: true,
                                              obscureText: false,
                                              decoration: InputDecoration(
